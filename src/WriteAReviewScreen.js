...
export default class WriteAReviewScreen extends Component {
  ...
  onClick_elSendButton = (ev) => {
    ...
    this.props.appActions.goToScreen('companydetails', { transitionId: 'fadeIn' });
      ...
      <div className="AppScreen WriteAReviewScreen" style={baseStyle}>
        ...
        <div className="layoutFlow" style={layoutFlowStyle}>
          ...
          <div className='elReviewerName'>
            <input className="baseFont" style={style_elReviewerName} type="text" placeholder={this.props.locStrings.addreview_reviewtextcopy_367397} onChange={this.textInputChanged_reviewerName} value={value_reviewerName !== undefined ? value_reviewerName : ''}  />
          </div>

          <div className='elReviewerEmail'>
            <input className="baseFont" style={style_elReviewerEmail} type="text" placeholder={this.props.locStrings.addreview_field_786827} onChange={this.textInputChanged_reviewerEmail} value={value_reviewerEmail !== undefined ? value_reviewerEmail : ''}  />
          </div>

          <div className='elReviewTitle'>
            <input className="baseFont" style={style_elReviewTitle} type="text" placeholder={this.props.locStrings.addreview_reviewtextcopy2_313895} onChange={this.textInputChanged_reviewTitle} value={this.state.reviewTitle}  />
          </div>
          ...
          <div className='elReviewText'>
            <textarea className="baseFont" style={style_elReviewText}  placeholder={this.props.locStrings.writeareview_textarea_652563} onChange={this.textAreaChanged_reviewText} value={this.state.reviewText}  />
          </div>
