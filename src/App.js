...
export default class App extends Component {
  constructor(props) {
    ...
    firebase.initializeApp({
        apiKey: "AIzaSyC72rzIzokNbZDiA89qKDjIBdxsuVd1Rvk",
        authDomain: "cootbie-live.firebaseapp.com",
        databaseURL: "https://cootbie-live.firebaseio.com",
        projectId: "cootbie-live",
        storageBucket: "cootbie-live.appspot.com",
        messagingSenderId: "727446301433",
        appId: "1:727446301433:web:8358f1a3b30c012e78d028",
        measurementId: "G-RYN95PBJDT"
      }
    );
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        ...
        case 'companydetails':
          return (<CompanyDetailsScreen {...screenProps} />)
        case 'writeareview':
          return (<WriteAReviewScreen {...screenProps} />)
        case 'companies':
          return (<CompaniesScreen {...screenProps} />)
        case 'loginmain':
